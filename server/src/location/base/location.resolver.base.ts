...
import { ServiceLineFindManyArgs } from "../../serviceLine/base/ServiceLineFindManyArgs";
import { ServiceLine } from "../../serviceLine/base/ServiceLine";
import { LocationType } from "../../locationType/base/LocationType";
...
export class LocationResolverBase {
  ...
  async createLocation(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        locationType: args.data.locationType
          ? {
              connect: args.data.locationType,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => [ServiceLine])
  @nestAccessControl.UseRoles({
    resource: "Location",
    action: "read",
    possession: "any",
  ...
  async serviceLine(
    ...
    const results = await this.service.findServiceLine(parent.id, args);
  ...
  @graphql.ResolveField(() => LocationType, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Location",
    action: "read",
    possession: "any",
  ...
  async locationType(
    ...
    const result = await this.service.getLocationType(parent.id);
