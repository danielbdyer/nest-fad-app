...
describe("InsurancePlan", () => {
  ...
  test("POST /insurance-plans", async () => {
  ...
  test("GET /insurance-plans/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/insurance-plans"}/${nonExistingId}`)
      .expect(404)
      .expect({
        statusCode: 404,
  ...
  test("GET /insurance-plans/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/insurance-plans"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
